...
const vote = sdk.getVote(process.env.REACT_APP_GOBERNANCE_CONTRACT);
...
(async () => {
  ...
  try {
    ...
    const amount = 6_900;
    const description = "Debería fuegartDAO transferir " + amount + " de tokens a " + process.env.REACT_APP_WALLET_ADDRESS + " por ser así de copado?";
    const executions = [
      {
