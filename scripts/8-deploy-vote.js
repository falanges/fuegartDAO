...
(async () => {
    try {
        const voteContractAddress = await sdk.deployer.deployVote({
            ...
            name: "Te re cabió fuegartDAO, lo sé",
            
            // This is the location of our governance token, our ERC-20 contract!
            voting_token_address: process.env.ERC_20_TOKEN,
        ...
        console.error("Failed to deploy vote contract, address", voteContractAddress);
    }
})();